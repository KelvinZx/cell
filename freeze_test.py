...
def train(model, weight_det=None, weight_cls=None,data_dir='',
    ...
    for i in range(len(key_list)):
        key_value = key_list[i].split('.')[0]
        if key_value == 'conv2' or key_value == 'conv3' or key_value == 'deconv1' or key_value == 'deconv2':
            #print(i)
            det_list.append(i)
        elif key_value == 'conv4' or key_value == 'deconv3' or key_value == 'deconv4':
            cls_list.append(i)
        else:
            base_list.append(i)
        ...
        for i, datapack in enumerate(val_loader, 0):
            ...
            if i % val_steps == val_steps - 1:
                ...
                if val_loss < best_loss:
                    best_loss = val_loss
                    torch.save(model.state_dict(), './ckpt/test_freeze.pkl')
                end = time.time()
